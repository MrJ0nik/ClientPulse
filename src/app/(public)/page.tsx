...
import Pricing from '../shared/components/Pricing/Pricing';
import Footer from '../shared/components/Footer/Footer';
import PublicRoute from '../(auth)/_components/publicRoute';
    ...
    <PublicRoute>
      <div className={classes.container}>
        ...
        <div className={classes.mainBlock}>
          ...
          <p className={classes.secondaryText}>
            Uncover hidden <strong>opportunities</strong>,{' '}
            <strong>track</strong> key decision-makers, and close deals faster.
          </p>
